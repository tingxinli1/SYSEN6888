...
output_file = './outputs/test_output_chatglm.txt'
...
for line in tqdm(test_data):
    ...
    # initial_prompt = tokenizer.bos_token + '%s->'
    # input_text = initial_prompt % product_description
    query = f"根据商品关键词【{product_description}】生成一小段广告。"
    input_text = tokenizer.build_prompt(query, None)
    # print(input_text)
